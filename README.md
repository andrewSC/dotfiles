...
sh -c "`curl -fsSL https://raw.githubusercontent.com/andrewSC/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/andrewSC/dotfiles/master/install.sh`" -s ask
```
